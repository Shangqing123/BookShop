...
import com.example.bookshop.adapter.GuideViewPagerAdapter;
...
public class WelcomeGuideActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_guide);//导航布局
		...
		for (int i = 0; i < pics.length; i++) {
			...
			if (i == pics.length - 1) {  //点击进入登录注册页面
				startBtn = (Button) view.findViewById(R.id.btn_login);//进入按钮
